...
valid_NMEA = [
    ...
    {"msg": "$GPGGA,104230,3723.5478,S,12218.8765,W,1,07,1.0,10.2,M,0.0,M,,*43", "lat": -37.392463, "lon": -122.314608, "alt": 10.2, "datetime": None},
    {"msg": "$GPGGA,152310,2503.1234,N,12134.5678,E,1,09,0.8,55.7,M,10.0,M,,*78", "lat": 25.052057, "lon": 121.57613, "alt": 55.7, "datetime": None},

    # GGA - BeiDou (BD)
    {"msg": "$BDGGA,091830,2233.1274,N,11404.6581,E,1,10,0.9,50.1,M,0.0,M,,*56", "lat": 22.552124, "lon": 114.077635, "alt": 50.1, "datetime": None},
    {"msg": "$BDGGA,132015,3010.8765,N,10234.4321,E,1,08,0.7,70.5,M,20.0,M,,*66", "lat": 30.181275, "lon": 102.573868, "alt": 70.5, "datetime": None},
    {"msg": "$BDGGA,183745,4056.7890,S,11618.8765,W,1,06,1.1,30.3,M,5.0,M,,*51", "lat": -40.946483, "lon": -116.314608, "alt": 30.3, "datetime": None},

    # GGA - GLONASS (GL)
    {"msg": "$GLGGA,141920,5540.1234,N,03736.8765,E,1,06,1.2,200.3,M,39.5,M,,*57", "lat": 55.668723, "lon": 37.614608, "alt": 200.3, "datetime": None},
    {"msg": "$GLGGA,112045,4523.6543,N,06234.9876,E,1,07,0.9,150.8,M,30.0,M,,*5B", "lat": 45.394238, "lon": 62.583127, "alt": 150.8, "datetime": None},
    {"msg": "$GLGGA,175310,3345.7890,S,04923.1234,W,1,08,0.6,80.4,M,25.0,M,,*6A", "lat": -33.76315, "lon": -49.38539, "alt": 80.4, "datetime": None},

    # GGA - Galileo (GA)
    {"msg": "$GAGGA,164500,3507.7890,N,13942.1234,E,1,09,0.8,75.4,M,15.0,M,,*68", "lat": 35.129817, "lon": 139.702057, "alt": 75.4, "datetime": None},
    {"msg": "$GAGGA,102530,2245.1234,N,01334.8765,E,1,08,1.0,90.2,M,18.0,M,,*61", "lat": 22.752057, "lon": 13.581275, "alt": 90.2, "datetime": None},
    {"msg": "$GAGGA,201815,5043.5678,N,01623.6543,E,1,10,0.7,110.5,M,12.0,M,,*50", "lat": 50.72613, "lon": 16.394238, "alt": 110.5, "datetime": None},

    # GGA - Mixed Constellation (GN)
    {"msg": "$GNGGA,102030,3723.5478,S,14515.8765,E,1,12,0.6,120.0,M,18.0,M,,*4D", "lat": -37.392463, "lon": 145.264608, "alt": 120.0, "datetime": None},
    {"msg": "$GNGGA,135040,4745.6789,N,08312.5432,W,1,09,0.9,60.1,M,14.0,M,,*75", "lat": 47.761315, "lon": -83.209053, "alt": 60.1, "datetime": None},
    {"msg": "$GNGGA,225540,5810.8765,S,00345.9876,E,1,11,1.1,95.8,M,20.0,M,,*71", "lat": -58.181275, "lon": 3.76646, "alt": 95.8, "datetime": None},

    # RMC - GPS (GP)
    {"msg": "$GPRMC,123519,A,4807.0380,N,01131.0000,E,022.4,084.4,230394,003.1,W*6A", "lat": 48.1173, "lon": 11.5167, "alt": 0.0, "datetime": dt.datetime(1994, 3, 23, 12, 35, 19)},
    {"msg": "$GPRMC,225446,A,5123.4560,N,01234.5670,E,054.7,089.5,150998,004.4,E*79", "lat": 51.3909, "lon": 12.576117, "alt": 0.0, "datetime": dt.datetime(1998, 9, 15, 22, 54, 46)},
    {"msg": "$GPRMC,153032,A,3402.6780,S,05823.1230,W,018.5,250.7,250601,006.8,W*6F", "lat": -34.044633, "lon": -58.385383, "alt": 0.0, "datetime": dt.datetime(2001, 6, 25, 15, 30, 32)},

    # RMC - BeiDou (BD)
    {"msg": "$BDRMC,142350,A,2456.7890,N,11458.1230,E,008.3,203.5,310721,001.2,W*74", "lat": 24.946483, "lon": 114.968717, "alt": 0.0, "datetime": dt.datetime(2021, 7, 31, 14, 23, 50)},
    {"msg": "$BDRMC,063415,A,2234.1230,S,11312.3450,E,005.0,092.0,170322,003.5,E*77", "lat": -22.568717, "lon": 113.20575, "alt": 0.0, "datetime": dt.datetime(2022, 3, 17, 6, 34, 15)},
    {"msg": "$BDRMC,184756,A,3210.8760,N,11534.5670,E,012.8,137.9,280822,002.3,W*77", "lat": 32.181275, "lon": 115.576117, "alt": 0.0, "datetime": dt.datetime(2022, 8, 28, 18, 47, 56)},

    # RMC - GLONASS (GL)
    {"msg": "$GLRMC,115632,A,5532.1230,N,03821.6540,E,014.2,178.9,110501,000.0,W*70", "lat": 55.535383, "lon": 38.3609, "alt": 0.0, "datetime": dt.datetime(2001, 5, 11, 11, 56, 32)},
    {"msg": "$GLRMC,093215,A,6043.9870,S,03015.8760,W,011.7,312.5,220822,001.9,E*62", "lat": -60.733116, "lon": -30.2646, "alt": 0.0, "datetime": dt.datetime(2022, 8, 22, 9, 32, 15)},
    {"msg": "$GLRMC,172845,A,4955.6540,N,03612.4320,E,023.1,045.2,080623,002.5,E*65", "lat": 49.927567, "lon": 36.2072, "alt": 0.0, "datetime": dt.datetime(2023, 6, 8, 17, 28, 45)},

    # RMC - Galileo (GA)
    {"msg": "$GARMC,201045,A,3645.1230,N,14012.3450,E,018.0,110.5,290522,003.0,E*64", "lat": 36.75205, "lon": 140.20575, "alt": 0.0, "datetime": dt.datetime(2022, 5, 29, 20, 10, 45)},
    {"msg": "$GARMC,045700,A,2222.8760,S,02434.6780,W,020.4,255.8,101015,004.5,W*74", "lat": -22.381267, "lon": -24.577967, "alt": 0.0, "datetime": dt.datetime(2015, 10, 10, 4, 57, 0)},
    {"msg": "$GARMC,132500,A,5055.4320,N,01323.8760,E,030.0,015.3,121220,005.6,E*6D", "lat": 50.923867, "lon": 13.397933, "alt": 0.0, "datetime": dt.datetime(2020, 12, 12, 13, 25, 0)},

    # RMC - Mixed Constellation (GN)
    {"msg": "$GNRMC,143512,A,3723.5478,S,14515.8765,E,033.6,275.4,080923,010.2,W*65", "lat": -37.392463, "lon": 145.264608, "alt": 0.0, "datetime": dt.datetime(2023, 9, 8, 14, 35, 12)},
    {"msg": "$GNRMC,224500,A,4745.6789,N,08312.5432,W,041.1,305.0,170722,009.3,E*78", "lat": 47.761315, "lon": -83.209053, "alt": 0.0, "datetime": dt.datetime(2022, 7, 17, 22, 45, 0)},
    {"msg": "$GNRMC,090123,A,5810.8765,S,00345.9876,E,012.5,180.0,220921,008.0,W*61", "lat": -58.181275, "lon": 3.76646, "alt": 0.0, "datetime": dt.datetime(2021, 9, 22, 9, 1, 23)}
]
