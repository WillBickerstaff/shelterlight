...
| `activity_debounce`       | int       | `15`    | Debounce time for activity detection inputs. This is the time that the input must remain in the changed state before the event will be registered.            |                   
